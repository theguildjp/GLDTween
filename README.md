GLDTween
========
パブリックAPIの評価テスト中につき、コードはまだ少数のみ運用で非公開です（ライブラリは完成度90%）。使い易さの目処がたった時点で公開します。コントリビュータに興味ある人はhttp://twitter.com/@fladdictまで
...
<dl>
<dt>アニメーション・カーブ</dt>
<dd>GLDEasingプロトコルを実装することで、自身で定義したオリジナルのアニメーションカーブを登録できます。</dd>
<dt>独自プロパティ</dt>
